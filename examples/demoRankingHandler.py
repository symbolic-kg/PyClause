...
train = f"{get_base_dir()}/data/yago3-10/train.txt"
filter_set = f"{get_base_dir()}/data/yago3-10/valid.txt"
target = f"{get_base_dir()}/data/yago3-10/test.txt"

rules = f"{get_base_dir()}/data/yago3-10/anyburl-rules-c3-3600"
